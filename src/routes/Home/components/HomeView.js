            ...
            <div>
              <ul className="firebaseui-idp-list">
                <li className="firebaseui-list-item">
                  ...
                  <button onClick={() => this.providerLogin('facebook')} className="firebaseui-idp-button mdl-button mdl-js-button mdl-button--raised firebaseui-idp-facebook firebaseui-id-idp-button">
                    <span className="firebaseui-idp-icon-wrapper">
